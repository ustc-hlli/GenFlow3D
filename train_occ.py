...
def training_process(args, logger, chk_dir):
    ...
    if(args.dataset.lower() == 'av2'):
        train_set = datasets.AV2(args.data_root,
                                     args.npoint,
                                     args.length_pre,
                                     args.length_fut,
                                     True)
...
if __name__ == '__main__':
    ...
    args = cmd_args.parse_args_from_yaml(os.path.join(root, 'train_cfg_occ.yaml'))
    ...
    files_to_save = ['models.py', 'units.py', 'layers.py', 'train_occ.py', 'train_cfg_occ.yaml', 'datasets.py', 'utils.py']
